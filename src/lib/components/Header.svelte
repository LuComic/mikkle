...
<div class="fixed top-0 left-1/2 z-30 mx-auto flex -translate-x-1/2 flex-col items-center">
	<!-- Ropes -->
	<div class="flex h-2 w-full items-center justify-between px-4 md:h-5 md:px-6">
		<div class="h-2 w-[2px] bg-amber-900 md:h-5"></div>
		<div class="h-2 w-[2px] bg-amber-900 md:h-5"></div>
	</div>

	<!-- Header hanging from ropes -->
	<a
		class="flex w-auto transform items-center justify-center gap-4 border border-r-2 border-b-2 bg-[#f6f2e8] px-2 py-1 shadow-lg visited:text-black md:px-4 md:py-2"
		href="/"
	>
